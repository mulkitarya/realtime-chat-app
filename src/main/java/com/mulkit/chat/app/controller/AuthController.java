...
}package com.mulkit.authsystem.controller;

import com.mulkit.authsystem.dto.AuthRequest;
import com.mulkit.authsystem.dto.AuthResponse;
import com.mulkit.authsystem.model.RefreshToken;
import com.mulkit.authsystem.model.User;
import com.mulkit.authsystem.repository.UserRepository;
import com.mulkit.authsystem.security.JwtUtil;
import com.mulkit.authsystem.security.RefreshTokenService;
import jakarta.validation.Valid;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.http.HttpStatus;
import org.springframework.http.ResponseEntity;
...
public class AuthController {
    ...
    public ResponseEntity<AuthResponse> registerAdmin(@Valid @RequestBody AuthRequest request) {
        ...
        return ResponseEntity
                .status(HttpStatus.CREATED)
                .body(new AuthResponse(true, "Admin registered successfully!"));
    }
